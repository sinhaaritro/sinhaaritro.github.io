...
export const technologyList: Technology = {
  ...
  Firebase: { icon: "Firebase", text: "Firebase", color: "blue" },
  Git: { icon: "Git", text: "Git", color: "orange" },
  GitHub: { icon: "Github", text: "GitHub", color: "blue" },
