        ...
        >
            ...
            >
                ...
                <div className={`flex border-t border-neutral-500 text-xl`}>
                    ...
                    <p className="w-1/2 p-2 flex place-content-center ">
                        Contact Me
                    </p>
                </div>
            </section>
            ...
            >
                ...
                <div className="p-6 px-12 flex flex-col gap-2 text-m text-center">
                    <p className="">
                        Hi, I am generalist programmer and designer. I love to
                        find out how all kinds software works and use them in a
                        creative way.
                    </p>
                    <p className="">
                        I first became interested in how computer works when I
                        played computer games in my childhood and before I knew
                        it, I was already interested in finding out how games
                        work. One thing lead to another and now I love making
                        games, apps, websites and design other softwares.
                    </p>
                    <p className="">
                        My interest in computer and technology helped me get
                        better and proficient in learning new things in
                        computer. At first I was only interested in learning the
                        programming aspects of it, but my focus shifted and now
                        I like to program and visually design everything.
                    </p>
                </div>
                ...
                <div className="p-12 flex flex-wrap place-content-center gap-2 text-m text-center">
                    {skillList.map((skill, i) => {
                        return <Chip key={i} {...skill} variant="large" />;
                    })}
                </div>
            </section>
        </section>
